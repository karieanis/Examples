...
class TSaslTransportTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testReceiveSaslMessageCompleteWithNoPayload() {
        ...
        $header = pack("CN", \Examples\Thrift\Transport\TSaslTransport::COMPLETE, 0);
        ...
        $saslTransport = $this->getMockBuilder("\Examples\Thrift\Transport\TSaslTransport")
        ...
        /* @var $response \Examples\Auth\SASL\Response */
        $response = $method->invoke($saslTransport);
        $this->assertInstanceOf("\Examples\Auth\SASL\Response", $response);
    ...
    public function testReceiveSaslMessageWithErrorStatusThrowsException() {
        ...
        $header = pack("CN", \Examples\Thrift\Transport\TSaslTransport::BAD, 40);
