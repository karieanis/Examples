<?php
namespace Examples\Test\Thrift\Shims;
...
class ThriftShim07Test extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        ...
        $this->shim = \Examples\Thrift\Shims\ThriftShim::getShim();

        $this->conf = $this->getMockBuilder("\Examples\Hadoop\Conf\HadoopDatabaseConf")
    ...
    /**
     * 
     * @return \Examples\Thrift\Shims\ThriftShim07
     */
    ...
    /**
     * @expectedException \Examples\Thrift\Shims\ThriftShimException
     */
    ...
    public function testSecondRegisterThrowsException() {
        $this->setExpectedException(
            "\Examples\Thrift\Shims\ThriftShimException",
            "Examples\Thrift\Shims\ThriftShim07 is currently registered as the running thrift shim and cannot be changed"
        );
