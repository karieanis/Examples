...
class HiveConnectionPoolTest extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        \Examples\Hive\Service\HiveServer::register();
        
        $this->BaseConfig['class'] = \Examples\Hive\Service\HiveServer::getRunningService()->getConnectionClass();
        $this->instance = \Examples\Hive\HiveConnectionPool::getInstance();
