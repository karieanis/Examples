...
class HivePDOStatementTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        $pdo = $this->getMockBuilder("\Examples\Hive\HivePDO")
            ->disableOriginalConstructor()
            ->getMock();
        
        $instance = new \Examples\Hive\HivePDOStatement($pdo);
        $this->assertInstanceOf("\Examples\Hive\HivePDOStatement", $instance);
    }
    ...
    public function testExecuteSuccessfully() {
        $stub = $this->getMockBuilder("\Examples\Hive\HivePDOStatement")
            ->disableOriginalConstructor()
    ...
    public function testFetchReturnsEmptyRowWithNoResultSet() {
        ...
        $rs = $this->getMockBuilder("\Examples\Hive\HivePDOResultSet")
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testFetchColumnWithMultipleCalls() {
        ...
        $map = $this->getMockBuilder("\Examples\Hive\Meta\KeyMap")
            ->disableOriginalConstructor()
    ...
    /**
     * 
     * @expectedException \Examples\Hive\HivePDOException
     */
    public function testCloseThrowsException() {
        ...
        $stub->expects($this->once())
            ...
            ->will($this->returnCallback(
                function() {
                    throw new \Examples\Hive\HivePDOException("Test exception");
                }
            )
        );
    ...
    public function testGetColumnCountWithSchema() {
        ...
        $schema = $this->getMockBuilder("\Examples\Hive\Meta\Schema")
            ->disableOriginalConstructor()
            ->setMethods(array("getKeyMap"))
            ->getMock();
