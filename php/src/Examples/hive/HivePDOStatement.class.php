...
class HivePDOStatement {
     ...
     * @throws \Examples\Hive\HivePDOException
     */
    public function close() {
        if($this->isOpen()) {
            ...
            } catch(\Examples\Hive\HivePDOException $e) {
                throw $e;
            }
    ...
    public function columnCount() {
        /* @var $schema \Examples\Hive\Meta\Schema */
     ...
     * @param \Examples\Hive\HivePDOResultSet $set
     * @return \Examples\Hive\HivePDOStatement
     * @codeCoverageIgnore
     */
    protected function setResultSet(\Examples\Hive\HivePDOResultSet $set) {
        $this->resultSet = $set;
        return $this;
    }
    ...
    protected function call($fn, $request) {
        ...
        try {
            ...
            throw new \Examples\Hive\HivePDOException(sprintf("Error occured whilst executing %s", $fn), $e->getCode(), $e);
        }
        ...
        if($response->status->statusCode == \TStatusCode::ERROR_STATUS) {
            ...
            throw \Examples\Hive\HivePDOException::factory($info);
        }
