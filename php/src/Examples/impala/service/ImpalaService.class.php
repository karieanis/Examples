<?php
namespace Examples\Impala\Service;
 ...
 * @codeCoverageIgnore
 */
class ImpalaService extends \Examples\Hadoop\Service\HadoopDatabaseService {
    ...
    protected function registerConf() {
        ...
        \Examples\Hadoop\Conf\HadoopDatabaseConfFactory::register("\Examples\Impala\Conf\ImpalaConf");
    }
}