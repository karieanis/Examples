<?php
namespace Examples\Thrift\Service;
...
class Factory {
     ...
     * @static
     * @param \Examples\Hadoop\Conf\HadoopDatabaseConf $configuration
     * @return \Examples\Thrift\Service\Container
     */
    public static function factory(\Examples\Hadoop\Conf\HadoopDatabaseConf $configuration) {
        ...
        $ServiceWrapper = \Examples\Hadoop\Service\HadoopDatabaseService::getRunningService();
