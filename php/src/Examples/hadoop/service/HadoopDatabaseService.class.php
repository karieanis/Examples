<?php
namespace Examples\Hadoop\Service;

use Examples\Hadoop\Conf\HadoopConfFactory;

use Examples\Hadoop\Conf\HadoopDatabaseConfFactory;
...
abstract class HadoopDatabaseService {
     ...
     * @var \Examples\Hadoop\Service\HadoopDatabaseService
     */
     ...
     * 
     * @param \Logger $logger
     * @return \Examples\Hadoop\Service\HadoopDatabaseService
     */
