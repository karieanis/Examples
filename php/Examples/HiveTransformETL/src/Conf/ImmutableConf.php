...
class ImmutableConf implements \ArrayAccess, \Iterator, \Countable {
    ...
    public function offsetSet($offset, $value) {
        throw new \Examples\HiveTransformETL\Exception\OperationNotAllowedException(
    ...
    /**
     * Wrap the passed confuration object in an instance of this to enforce immutability
     * @param BaseConf $conf
     * @return \Examples\HiveTransformETL\Conf\ImmutableConf
     */
    public static function wrap(BaseConf $conf) {
