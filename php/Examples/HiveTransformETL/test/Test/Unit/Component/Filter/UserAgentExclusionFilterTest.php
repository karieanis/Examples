...
class UserAgentExclusionFilterTest extends \PHPUnit_Framework_TestCase {
    public function testFilter() {
        ...
        $stub = $this->getMockBuilder("\Examples\HiveTransformETL\Component\Filter\UserAgentExclusionFilter")
            ->disableOriginalConstructor()
            ->setMethods(array('getRules'))
            ->getMock();
        
        $rule = $this->getMockBuilder("\Examples\HiveTransformETL\Component\Filter\Rules\UserAgentBlacklistRule")
            ->disableOriginalConstructor()
