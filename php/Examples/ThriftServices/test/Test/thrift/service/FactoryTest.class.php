<?php 
namespace Examples\ThriftServices\Test\Thrift\Service;

/**
 * Tests covering multiple scenarios regarding the use of \Examples\ThriftServices\Thrift\Service\Factory
...
class FactoryTest extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        $this->configuration = $this->getMockBuilder("\Examples\ThriftServices\Hive\Conf\HiveConf")
    ...
    public function testFactoryWithSingleHostAndMutiplePorts() {
        ...
        $test['auth_mechanism'] = \Examples\ThriftServices\Auth\SASL\Mechanism\BaseMechanism::NOSASL;
        
        $service = \Examples\ThriftServices\Thrift\Service\Factory::factory($test);
        
        $this->assertInstanceOf("\Examples\ThriftServices\Thrift\Service\Container", $service);
    ...
    public function testFactoryWithSingleHostAndSinglePortAndSASLAuth() {
        ...
        $test['host'] = "server1";
        $test['port'] = "10000";
        $test['auth_mechanism'] = \Examples\ThriftServices\Auth\SASL\Mechanism\BaseMechanism::PLAIN;
    
        $service = \Examples\ThriftServices\Thrift\Service\Factory::factory($test);
    
        $this->assertInstanceOf("\Examples\ThriftServices\Thrift\Service\Container", $service);
        $this->assertInstanceOf("\Examples\ThriftServices\Thrift\Transport\TSaslClientTransport", ($transport = $service->getTransport()));
    }
