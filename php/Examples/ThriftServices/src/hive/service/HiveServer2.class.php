...
class HiveServer2 
    ...
    protected static $ConfClass        = "\Examples\ThriftServices\Hive\Conf\HiveServer2Conf";
    ...
    public function getTransport($class, \Examples\ThriftServices\Hadoop\Conf\HadoopDatabaseConf $conf) {
        ...
        return \Examples\ThriftServices\Thrift\Transport\TSaslTransportFactory::factory(
            $this->getShim()->getTransport($class, $conf), 
            $conf['auth_mechanism'], $conf['username'], $conf['password']
        );
    }
