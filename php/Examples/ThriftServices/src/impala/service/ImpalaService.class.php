 ...
 * @codeCoverageIgnore
 */
class ImpalaService extends \Examples\ThriftServices\Hadoop\Service\HadoopDatabaseService {
    ...
    protected function registerConf() {
        ...
        \Examples\ThriftServices\Hadoop\Conf\HadoopDatabaseConfFactory::register("\Examples\ThriftServices\Impala\Conf\ImpalaConf");
    }
}