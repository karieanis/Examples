...
class Plain extends BaseMechanism {
     ...
     */
    public function __construct(\Examples\ThriftServices\Auth\SASL\Client $client, $username = null, $password = null) {
     ...
     * @param string $username
     * @return \Examples\ThriftServices\Auth\SASL\Mechanism\Plain
     */
